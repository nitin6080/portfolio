        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="relative group">
              ...
              <div className="relative bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-2xl p-8">
                <div className="flex items-center space-x-6">
                  ...
                  <div className="relative">
                    ...
                    <div className="absolute -bottom-2 -right-2 bg-green-500 w-8 h-8 rounded-full border-4 border-slate-800 flex items-center justify-center">
                      <span className="text-xs font-bold text-white">{personal.yearsOfExperience}+</span>
                    </div>
                  </div>
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-cyan-400 font-medium mb-1">{personal.title}</p>
                ...
                <div className="mt-6 pt-6 border-t border-slate-700 space-y-2">
                  <a href={`mailto:${personal.email}`} className="text-slate-400 hover:text-cyan-400 transition-colors text-sm block">
                    📧 {personal.email}
                  </a>
                  <a href={`tel:${personal.phone}`} className="text-slate-400 hover:text-cyan-400 transition-colors text-sm block">
                    📞 {personal.phone}
                  </a>
                </div>
              </div>
          ...
          >
            ...
            <div>
              ...
              <p className="text-slate-300 leading-relaxed mb-4">{about.summary}</p>
              <p className="text-slate-400 leading-relaxed">{about.description}</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-cyan-500/10 to-blue-500/10 border border-cyan-500/20 rounded-xl p-6">
              <p className="text-slate-300 leading-relaxed italic">
                "Passionate about building performant, accessible web applications that deliver
                exceptional user experiences. Always learning, always improving."
              </p>
            </div>
          </div>
        </div>
